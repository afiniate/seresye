...
%-define(BREAK, break).     % <- Uncomment to break siblings test, breaks before assertMatch
...
no_siblings_test() ->
    ...
    Engine1 = seresye_engine:new([]),

    Engine2 = seresye_engine:add_rules(Engine1, ?MODULE),

    Engine3 = seresye_engine:assert (Engine2, ?DATA_WITHOUT_SIBLINGS),
...
no_parents_test() ->
    ...
    Engine3 = seresye_engine:assert (Engine2, ?DATA_WITHOUT_PARENTS),

    case seresye_engine:get_client_state(Engine3) of
        [] -> [];
        InternalState -> 
